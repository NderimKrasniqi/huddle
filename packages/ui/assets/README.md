...
`apps/phone/assets/join-room`, outside this shared boundary. All other product
visuals and the previous redesign importer remain absent; Git history is the
archive for superseded artwork.
